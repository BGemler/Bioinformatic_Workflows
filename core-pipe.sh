...
trimmomatic_str="LEADING:3 TRAILING:3 SLIDINGWINDOW:5:20 MINLEN:50"


# Read Locations
fastq_loc="../sequence_reads/Fredrick_4/"
...
# Trimmomatic
#Nano-ReadTrim/run trimmomatic FALSE $raw_loc $trim_loc \
#                        -threads $threads \
#                        $trimmomatic_str
...
# Conduct assembly -t $threads 
echo "Running assembly"
Nano-Assembly/run $trim_loc "../reference_genomes/GCF_000016645.1_ASM1664v1_genomic.fna" "../reference_genomes/GCF_000016645.1_ASM1664v1.gff" $assembly_loc --isolate
